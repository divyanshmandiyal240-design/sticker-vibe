...
const products = [
  ...
  // ── MOTIVATIONAL ──────────────────────────────────
  {
    id: 13, name: "Main Character", cat: "motivational", emoji: "⭐",
    price: 4.99, bg: "linear-gradient(135deg,#55efc4,#00b894)",
    badge: "FAV", stripeLink: "#"
  },
  {
    id: 14, name: "You Got This", cat: "motivational", emoji: "💪",
    price: 3.99, bg: "linear-gradient(135deg,#74b9ff,#0984e3)",
    badge: null, stripeLink: "#"
  },
  {
    id: 15, name: "Slay All Day", cat: "motivational", emoji: "👑",
    price: 4.99, bg: "linear-gradient(135deg,#ffeaa7,#fdcb6e)",
    badge: null, stripeLink: "#"
  },
  {
    id: 16, name: "Glow Up Era", cat: "motivational", emoji: "✨",
  ...
  // ── FUNNY ─────────────────────────────────────────
  {
    id: 17, name: "Vibe Check", cat: "funny", emoji: "✅",
    price: 3.99, bg: "linear-gradient(135deg,#55efc4,#00cec9)",
    badge: "HOT", stripeLink: "#"
  },
  {
    id: 18, name: "No Thoughts", cat: "funny", emoji: "🧠",
    price: 3.99, bg: "linear-gradient(135deg,#fd79a8,#e84393)",
    badge: null, stripeLink: "#"
  },
  {
    id: 19, name: "Understood 📝", cat: "funny", emoji: "📝",
    price: 4.99, bg: "linear-gradient(135deg,#fdcb6e,#e17055)",
    badge: null, stripeLink: "#"
  },
  {
    id: 20, name: "It's Giving 💅", cat: "funny", emoji: "💅",
...
function renderProducts(filter = 'all') {
  ...
  list.forEach((p, i) => {
    ...
    card.innerHTML = `
      <div class="sticker-img" style="background:${p.bg}">
